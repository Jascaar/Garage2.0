...
namespace Garage2._0.Controllers
{
    public class MembersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,SSN,FirstName,LastName,SignUpTime,Cellular,Email,Street,StreetNumber,OfficialApartmentNumber,PostCode,City,Country,Gender")] Member member)
        {
